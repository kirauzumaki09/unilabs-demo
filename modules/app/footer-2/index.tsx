...
const FooterTwo = () => {
  ...
  return (
    <>
      <div className="footer-two-sec relative pb-90 pt-[100px]">
        <div className="container mx-auto flex-col flex w-full px-14 max-lg:px-5 z-1 relative">
              ...
              <form>
                <div className="form-intput relative">
                  <input
                    ...
                    className="backdrop-blur-[30px] rounded-[30px] size-full bg-secondary h-[90px] pl-[42px] pr-[240px] outline-none placeholder:text-[#DBDBDB]"
                  />
                  <input
                    type="submit"
                    value="Subscribe"
                    className="absolute top-0 right-0 bg-gradient-to-r from-accent-foreground to-primary-foreground max-w-[232px] px-[77px] h-full rounded-r-[30px] outline-none text-[16px] text-[#04111B] font-inter font-medium cursor-pointer hover:opacity-75"
                  />
                </div>
              </form>
            </div>
          ...
          <div className="copyright flex align-center justify-center">
            <p className='pr-[18px] mr-[18px] relative before:content-[""] before:absolute before:right-0 before:top-[12px] before:size-[4px] before:bg-[#fff] before:rounded-full'>
