          ...
          <FadeInOnScroll className="lg:max-w-[489px] w-full">
            <div className="whyfund-card">
              <div className="whyfund-head-wrap">
                ...
                <p>Optimized Liquidity and Market Adaptability</p>
              </div>
              <p>
            ...
            <div className="flex flex-col gap-7">
              <FadeInOnScroll className="lg:max-w-[489px] w-full">
                <div className="whyfund-card">
                  <div className="whyfund-head-wrap">
                    <Checkmark className="checkmark" />
                    <p>Yield Generation on Bitcoin Holdings</p>
                  </div>
                  <p>
            ...
            <div className="flex flex-col gap-7 lg:absolute left-[51.5%] -top-[57%]">
              <FadeInOnScroll className="lg:max-w-[489px] w-full">
                <div className="whyfund-card">
                  <div className="whyfund-head-wrap">
                    <Checkmark className="checkmark" />
                    <p>Beyond Spot Bitcoin Holdings</p>
                  </div>
                  <p>
              ...
              <FadeInOnScroll className="lg:max-w-[489px] w-full">
                <div className="whyfund-card">
                  <div className="whyfund-head-wrap">
                    <Checkmark className="checkmark" />
                    <p>Diversified Bitcoin-Based Asset Basket</p>
                  </div>
                  <p>
