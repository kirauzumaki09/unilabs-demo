                        ...
                        <div className='flex flex-wrap'>
                            <div className='w-[162px] h-[162px] overflow-hidden rounded-[14px]'>
                                <Link href='#' className='w-full h-full inline-block'>
                                    <Image className='w-full h-full object-cover' src={assets.FundUpdate2} width={162} height={162} alt='recent-update-image'/>
                                </Link>
                                
                            </div>
                            <div className='max-w-[calc(100%-162px)] pl-[32px] w-full'>
                                <p className="text-[18px] font-medium text-[#2DC4EC] leading-[1.2] mb-[16px]">1 May, 2025</p>
                                <h3 className="text-[24px] font-semibold mb-[16px] font-anybody capitalize">
                                    <Link className="inline-block" href='#'>Fund Update 2</Link>
                                </h3>
                                <p className="text-[18px] leading-[1.8] capitalize">
                                    Our team is excited to share today’s progress on building the foundation...
                                </p>
                            </div>
                        </div>
