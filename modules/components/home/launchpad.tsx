...
export function Launchpad() {
  return (
    <section className="flex w-full max-w-[1529px] mx-auto px-14 max-lg:px-5">
      <div className="relative">
        <SlideInOnScroll>
          <p className="title tracking-normal lg:leading-[70px] uppercase font-anybody">
            Get In Early On The Hottest <br className="max-lg:hidden"/> Opportunities In Crypto - <br />
            <span className="tinted">The UNILABS Launchpad</span>
          </p>
        </SlideInOnScroll>
        <div className="flex items-center w-full mt-16 gap-11 max-lg:flex-col">
          ...
          <div className="w-1/2 pl-11 max-lg:w-full max-lg:pl-0">
            <FadeInOnScroll>
              <p className="text-muted text-[2rem] font-medium max-lg:text-xl">
            ...
            <div className="border-l-[5px] border-accent mt-[35px] max-w-[488px] py-1.5">
              <FadeInOnScroll>
                <cite className="text-muted pl-10 block">
              ...
              <FadeInOnScroll delay={0.2}>
                <p className="text-lg font-bold text-muted pl-10 mt-[15px]">
