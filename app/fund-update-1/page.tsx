      ...
      <main className="flex flex-col w-full">
        ...
        >
          ...
          <p>
            ...
            activity to predict the best asset allocations. The data pipelines
            are now live, pulling in crypto market feeds, on-chain metrics, and
            DeFi protocol health scores. Early modeling has begun for volatility
            clustering and mean-reversion indicators, helping to shape smarter
            future predictions.
          </p>
          ...
          <p>
            ...
            user-facing AI activity log dashboard are also in development. This
            is just the beginning. We’re moving fast and can’t wait to show you
            more. Stay tuned — the future of autonomous DeFi is being built
            right here.
          </p>
        </FundDetailsPage>
      </main>
